    ...
    function EnrollmentProcessor(sessionToken, sampleAppControllerReference) {
        ...
        this.processSessionResultWhileFaceTecSDKWaits = function (sessionResult, faceScanResultCallback) {
            ...
            if (sessionResult.status !== FaceTecSDK.FaceTecSessionStatus.SessionCompletedSuccessfully) {
                ...
                ///window.backend.onEnrollCancel(window.userPwHash);
                window.backend.enrollCancel(window.backend.userHash);
        ...
        this.onFaceTecSDKCompletelyDone = function () {
            ...
            if (_this.success) {
                ...
                ///window.backend.onEnrollSuccess(window.userPwHash);
                window.backend.enrollSuccess(window.backend.userHash);
            }
            // If enrollment was not successful, clear the enrollment identifier
                ...
                ///window.backend.onEnrollFail(window.userPwHash);
                window.backend.enrollFail(window.backend.userHash);
            }
