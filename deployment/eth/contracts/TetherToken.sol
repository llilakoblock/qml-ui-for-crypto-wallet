...
abstract contract BasicToken is Ownable, ERC20Basic {
    ...
    */
    function transfer(address _to, uint _value) public virtual override(ERC20Basic) onlyPayloadSize(2 * 32) {
...
contract TetherToken is Pausable, StandardToken, BlackList {
    ...
    // Forward ERC20 methods to upgraded contract if this one is deprecated
    function balanceOf(address who) public override(ERC20Basic, BasicToken) view returns (uint) {
        if (deprecated) {
